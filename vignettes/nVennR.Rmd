...
```{r "setColors"}
showSVG(nVennObj = myV2, setColors = c('#d7100b', 'teal', 'yellow', 'black', '#2b55b7'))
```
...
```{r "showLabels"}
showSVG(nVennObj = myV2, opacity = 0.1, labelRegions = F, fontScale = 3) # Avoid overlaps by hiding region labels
```
